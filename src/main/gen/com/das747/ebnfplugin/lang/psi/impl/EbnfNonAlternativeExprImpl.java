...
public class EbnfNonAlternativeExprImpl extends EbnfTreeNodeImplMixin implements EbnfNonAlternativeExpr {

  public EbnfNonAlternativeExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull EbnfVisitor visitor) {
    visitor.visitNonAlternativeExpr(this);
  }
